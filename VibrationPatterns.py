...
if __name__ == "__main__":
    ...
    from vest_device import I2CVestDevice
    import json
    import time
    #vest_device = DummyVestDevice()
    with I2CVestDevice(0x40) as vest_device:    
        vest_controller = VestController(vest_device, range(16))
